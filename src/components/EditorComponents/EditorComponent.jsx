...
function EditorComponent() {
  ...
  useEffect(() => {
    ...
    dispatch(setCurrentProblemId("6631872ce46214c689c9bf00"));
    const fetchTestCases = async () => {
      try {
        const testCasesL = localStorage.getItem(`testCases${currentProblemId}`);
        if (testCasesL) {
          ...
          const config = {
            ...
            url: "http://localhost:8800/judge/getTestCases/6631872ce46214c689c9bf00",
            headers: {},
          };
